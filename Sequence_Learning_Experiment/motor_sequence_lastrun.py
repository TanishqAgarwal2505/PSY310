...
expName = 'motor_sequence'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\Admin\\Desktop\\LAB\\Self\\Motor_seq\\motor_sequence_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    for thisTrial in trials:
        ...
        trialComponents = [fixation, line1, line2, line3, line_4, probe, key_resp]
