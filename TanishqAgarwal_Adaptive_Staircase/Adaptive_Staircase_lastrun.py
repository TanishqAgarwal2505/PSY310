...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\tanis\\Desktop\\LAB\\Self\\Adaptive\\Adaptive_Staircase_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    for thisStair in stair:
        ...
        # Run 'Begin Routine' code from fiftyfifity
        if random() > 0.5: #50:50 propbability
            direction = -level
            corr_resp = 'left'
        else:
            direction = level
        ...
        # Run 'End Routine' code from fiftyfifity
